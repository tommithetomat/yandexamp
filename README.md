...
- 🎚 Панели (плейлист, эквалайзер, тексты) можно перетаскивать и менять местами, плейлист — тянуть по высоте
- 🗔 Мини-режим — компактная полоска управления, и `PIN` — окно поверх всех остальных
- 🎹 Медиаклавиши, значок в трее и системный медиа-оверлей с обложкой

**Музыка**

- 📚 Ваши плейлисты + подборки Яндекса: Плейлист дня, Премьера, Дежавю
- ❤️ «Мне нравится» — вся библиотека лайков целиком; лайки и дизлайки прямо из плеера
...
- 📻 Жанровые и тематические станции, чарт Яндекса, новинки и история прослушиваний
- 🎙 Тексты песен и страница исполнителя (популярное + альбомы) в боковой панели
- 📡 «Радио по треку» — запустить бесконечный поток похожего на выбранный трек
- 🔎 Поиск по всей Яндекс Музыке; если трек уже в плейлисте — плеер переходит к нему, а не дублирует
- 🎬 Управление плейлистом: перетаскивание треков, «поставить следующим», удаление
...
- ⬆ Уведомление о новой версии прямо в плеере
...
Приложение не подписано сертификатами Microsoft и Apple — отсюда предупреждения при первом запуске.
